...
_REASONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "window_open": "The window/door in {n} is already open.",
        "window_closed": "Open the window/door in {n}.",
        "no_room": "No indoor room below the humidity limit.",
        "no_room_data": "No sensor data from any room right now.",
    ...
    "de": {
        ...
        "window_open": "Fenster/Tür in {n} steht schon offen.",
        "window_closed": "Fenster/Tür in {n} öffnen.",
        "no_room": "Kein Innenraum unter der Feuchtegrenze.",
        "no_room_data": "Gerade keine Sensordaten aus den Räumen.",
